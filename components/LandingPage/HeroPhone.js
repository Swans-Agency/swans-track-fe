    ...
    return (
        <div className='px-3 flex flex-col items-center text-center w-[100%] tablet:px-10'>
            ...
            <iframe
                ...
                allowfullscreen
            ></iframe>
            <p className='text-[1.3rem] tracking-[0.2rem] my-[15px] font-extralight text-textIcons'>
            ...
            <button
                className='py-3 px-8 text-[1.5rem] text-white hover:text-[#dc2626] hover:bg-mainBackground bg-[#dc2626] rounded-lg border border-[#dc2626] flex items-center gap-x-2'
