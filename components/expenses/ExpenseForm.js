    ...
    return (
        ...
        >
            <div className='flex gap-x-5 w-full mt-0'>
                <Form.Item label="Expense Description" name="description" className='w-full' required>
                    <Input className='rounded' />
                </Form.Item>
                <Form.Item label="Expense Amount" name="amount" className='w-full' required>
                    <InputNumber min={0} className='rounded w-full' addonAfter={<MoneyCollectOutlined className='pb-1' />} />
                </Form.Item>
            </div>
            <div className='flex gap-x-5 w-full mt-0'>
                <Form.Item label="Expense Category" name="category" className='w-full' required>
                    <Select
                        showSearch
                        defaultValue=""
                        style={{
                        ...
                        options={[
                            ...
                            { "label": "Insurance/Health insurance", "value": "Insurance/Health insurance" },
                            ...
                            { "label": "Storage/Cloud storage", "value": "Storage/Cloud storage" },
                ...
                <Form.Item label="Expense Date" name="date" className='w-full' required>
                    <DatePicker  format="YYYY-MM-DD" className='rounded w-full' placeholder='' />
                </Form.Item>
            </div>
