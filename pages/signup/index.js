    ...
    return (
        <div className='bg-cover bg-center min-h-screen bg-[conic-gradient(at_top_left,_var(--tw-gradient-stops))] from-black via-gray-700 to-gray-500 flex flex-col items-center'>
            <div className='bg-[#e2e4eb] w-fit mt-10 rounded-lg'>
                <h1 className='text-[2.875rem] font-extrabold tracking-tighter py-6 px-10 text-center'>Join the Swans</h1>
                <Form
                    onFinish={onFinish}
                    layout="vertical"
                ...
                >
                    ...
                    <Form.Item
                        ...
                        required
                        tooltip={{
                            title: 'Your company name, i.e. swansagency. Note that it should be all in small letters, any spaces will be replaced with an underscore.',
                ...
                <div className='flex justify-center items-center'>
                    ...
                    <p className=' px-10 py-1 italic max-w-[400px] text-gray-600  text-center '>
                        By selecting Create Account, you agree to our <span onClick={() => router.push("/terms-conditions")} className='hover:cursor-pointer text-blue-500' href="/terms-conditions">Terms</span> and have read and acknowledge our <span onClick={() => router.push("/swans-privacy-policy")} className='hover:cursor-pointer text-blue-500'>Global Privacy Statement.</span>
                    </p>
                </div>

                <div className='bg-[#163757] py-5 mt-[5rem] text-center rounded-b-lg'>
                    <Link href="/login" className='text-white'>Already a user?</Link>
                </div>
            </div>
