                        ...
                        <div className='px-2 border rounded-lg max-h-[350px] pb-2'>
                            <div className='flex justify-between items-center bg-white !z-10 '>
                                ...
                                <div onClick={() => { handleShowBoard() }} >
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 hover:cursor-pointer hover:bg-foreignBackground hover:text-white rounded-full p-1">
