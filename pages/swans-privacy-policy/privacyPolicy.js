    ...
    <>
      ...
      <div className="desktop:px-[20rem] tablet:px-[10rem] phone:px-5 text-left pt-10 pb-24 text-black">
        ...
        <ul className="pl-5 mt-2 space-y-1 list-disc list-inside">
          ...
          <li>
            Client information, including client names and contact details.
          </li>
          <li>
            User-generated content, such as invoices, proposals, and tasks.
          </li>
          <li>
            Usage data, including IP address, browser type, and operating
            system.
          </li>
        </ul>
        ...
        <ul className="pl-5 mt-2 space-y-1 list-disc list-inside">
          <li>
            Providing and improving our web app's functionality and services.
          </li>
          <li>
            Managing user accounts, including client and team member
            information.
          </li>
          <li>
            Generating and processing invoices, proposals, and other
            user-generated content.
          </li>
          <li>
            Communicating with users regarding updates, new features, and
            support.
          </li>
          <li>
            Analyzing user preferences, trends, and usage patterns to enhance
            user experience.
          </li>
          <li>
            Enforcing our terms of service and preventing unauthorized
            activities.
          </li>
        </ul>
        ...
        <ul className="pl-5 mt-2 space-y-1 list-disc list-inside">
          ...
          <li>
            To trusted service providers who assist us in operating and
            maintaining our web app.
          </li>
          <li>When required by law or to comply with legal obligations.</li>
          <li>
            To protect our rights, property, or safety, as well as that of our
            users or others.
          </li>
        ...
        <p>
          We take appropriate security measures to protect personal information
        ...
        <p>
          ...
          practices or content of such third parties. We encourage users to
          review the privacy policies of these third-party websites or services
        ...
        <p>
          ...
          information. They may also have the right to withdraw consent or
          object to certain data processing activities. To exercise these
        ...
        <p>
          ...
          updated Privacy Policy on our web app.
        </p>

        <h2 className="text-[1.5rem] font-bold pt-4">8. Contact Us</h2>
        <p>
          If you have any questions, concerns, or requests regarding this
          Privacy Policy, please contact us at support@swanstrack.com.
        </p>
      </div>
    </>
  );
